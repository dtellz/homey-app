import './style.css'
import { InputGroup, InputLeftElement, Input, Icon, Text, Box, Button } from '@chakra-ui/react';
    ...
    return (
        <Box className='dashboard-header__container'>
            ...
            <div className='header__element'>
                ...
                <Link to='/dashboard' className='header__link' ><Text color='gray.500' fontWeight={700}>Private</Text></Link>
            </div>
